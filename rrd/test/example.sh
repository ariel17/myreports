...
$RRDTOOL create $RRD_FILE --start 1321922514 --step 60 \
    DS:$VARIABLE:$SOURCE_TYPE:120:U:U \
...
$RRDTOOL graph $RRD_IMAGE --start 1321922580 --end 1321923180 \
    --vertical-label $VARIABLE \
    DEF:v_$VARIABLE=$RRD_FILE:$VARIABLE:AVERAGE \
    AREA:v_$VARIABLE#$COLOR1 \
    HRULE:600#002800:"Maximum allowed"
